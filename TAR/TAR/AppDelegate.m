...
@synthesize wilddog, storyboard, defaultAction, uid, name;
...
//    user_ref = [firebase child:@"users"];
    ...
    wilddog = [[WDGSync sync] reference];
...
//    UIView * baiduSplashContainer = [[UIView alloc]initWithFrame:CGRectMake(0, 0, screenWidth, screenHeight*0.85)];
...
//    icon.image = [UIImage imageNamed:@"icon_TAR.png"];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "z.TAR" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"TAR" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"TAR.sqlite"];
    NSError *error = nil;
